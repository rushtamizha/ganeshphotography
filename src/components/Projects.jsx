...
/* ================= YOUTUBE PROJECTS DATA ================= */
const projects = [
  {
    title: "Olivia & Liam Wedding Film",
    tags: ["Wedding", "Cinematic"],
    youtubeUrl: "https://youtu.be/k2qgadSvNyU?si=Oy7d4rRneyVVmUe3",
  },
  {
    title: "Williams Family Portrait Film",
    tags: ["Family", "Photography"],
    youtubeUrl: "https://youtu.be/__6sIqZk-DA?si=fKfGtV5fsawiFC_e",
  },
  {
...
export default function Projects() {
  ...
  return (
    <section className="relative hidden bg-[#03141d] py-20" id="projects">
                ...
                >
                  ...
                  <div className="relative overflow-hidden rounded-xl">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#43bfd0] text-[#03141d] text-xl font-bold">
                        ▶
                      </div>
                    </div>
                  </div>
